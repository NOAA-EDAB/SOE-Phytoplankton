; $ID:	SOE_STACKED_TIMESERIES_PLOT.PRO,	2021-12-23-15,	USER-KJWH	$
  PRO SOE_STACKED_TIMESERIES_PLOT, VERSION, BUFFER=BUFFER, OVERWRITE=OVERWRITE
...
; ****************************************************************************************************
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    PERIOD = VERSTR.INFO.GRID_PERIOD
    ...
    IF ~N_ELEMENTS(DIR_PLOTS) THEN DIR_PLT = VERSTR.DIRS.DIR_PLOTS+'INTERP'+SL ELSE DIR_PLT = DIR_PLOTS & DIR_TEST, DIR_PLT
    ...
    FOR S=0, N_ELEMENTS(SPRODS)-1 DO BEGIN
      ...
      FOR N=0, N_ELEMENTS(NAMES)-1 DO BEGIN
        ...
        FOR R=0, N_ELEMENTS(PRODS)-1 DO BEGIN
          ...
          LAYOUT[2] = COUNTER
          STACKED_GRIDDED_TIMESERIES, NSTR, PTAG, YEARS=YEARS, OBJ=W, LAYOUT=LAYOUT,$
            PROD=SPROD, PAL=PAL, MARGIN=MARGIN, /CURRENT,$
            /ADD_CB, CB_POS=CB_POS, CB_TYPE=5, CB_TITLE=PROD_TITLE
