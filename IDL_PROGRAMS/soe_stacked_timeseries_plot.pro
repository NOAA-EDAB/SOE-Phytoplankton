    ...
    FOR H=0, N_ELEMENTS(SHAPES)-1 DO BEGIN ; Shapefile loop
      ...
      FOR N=0, N_ELEMENTS(NAMES)-1 DO BEGIN
        ...
        FOR R=0, N_ELEMENTS(PRODS)-1 DO BEGIN
          ...
          LAYOUT[2] = COUNTER
          IF NSTR NE [] THEN STACKED_GRIDDED_TIMESERIES, NSTR, PTAG, YEARS=YEARS, OBJ=W, LAYOUT=LAYOUT,PROD=SPROD, PAL=PAL, MARGIN=MARGIN, /CURRENT,/ADD_CB, CB_POS=CB_POS, CB_TYPE=5, CB_TITLE=PROD_TITLE
