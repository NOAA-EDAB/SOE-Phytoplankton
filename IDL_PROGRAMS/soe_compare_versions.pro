...
; ****************************************************************************************************
  ...
  FOR F=0, N_ELEMENTS(OUTPUT_FILES)-1 DO BEGIN
    ...
    CASE OUTPUT_FILES[F] OF 
      ...
      'PP_REQUIRED': BEGIN  
        VERDAT = VERSTR.DIRS.DIR_PPREQ_EXTRACTS + 'NES_EPU_NOESTUARIES' + SL + 'FINAL_MERGED_SUMS' + SL + 'MERGED_ANNUAL_SUM-NES_EPU_NOESTUARIES-PPD-VGPM2_CHLOR_A-CCI-STATS-' + VERYEAR + '.SAV'
        PRDS = ['CHLOR_A','PPD']
