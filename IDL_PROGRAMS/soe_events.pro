...
;        ENDFOR
        ...
        FOR D=0, N_ELEMENTS(PRODS)-1 DO BEGIN
          ...
          CASE APROD OF
            'SST': BEGIN & DSET='ACSPO' & INMAP='L3B2' & PROD_SCALE='TEMP_-5_5' & CBTITLE='Surface Temperature Difference!C(!Uo!NC)' & SPAL = 'PAL_BLUE_WHITE_RED' & END
            'BTEMP': BEGIN & DSET='GLORYS' & INMAP='NWA' & SCALE='TEMP_-5_5' & CBTITLE='Bottom Temperature Difference!C(!Uo!NC)' & SPAL = 'PAL_BLUE_WHITE_RED' & END
          ENDCASE
