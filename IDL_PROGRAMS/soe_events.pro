      ...
      '2024_SST_ANOMALY': BEGIN
        ...
        FOR R=0, N_ELEMENTS(PERIODS)-1 DO BEGIN
          ...
          FOR S=0, N_ELEMENTS(PERS)-1 DO BEGIN
            ...
            CBAR, PROD_SCALE, IMG=IMG, FONT_SIZE=13, CB_TYPE=1, CB_POS=CB_POS, CB_TITLE=UNITS('TEMP'), PAL=SPAL,CB_TICKVALUES=TICKVALS, CB_TICKNAMES=TICKNAMES,_EXTRA=_EXTRA,RELATIVE=CB_RELATIVE, CB_OBJ=CB_IMG
            ...
            CBAR, PROD_SCALE, IMG=OBJ, FONT_SIZE=13, CB_TYPE=3, CB_POS=CB_POS, CB_TITLE='(!Uo!NF)', PAL=SPAL, CB_TICKVALUES=FTICKVALS, CB_TICKNAMES=FTICKNAMES,RELATIVE=CB_RELATIVE, CB_OBJ=CB_IMG2
