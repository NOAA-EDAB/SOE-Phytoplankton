; $ID:	SOE_COMPARE_ANNUAL_DATA.PRO,	2023-09-19-09,	USER-KJWH	$
  PRO SOE_COMPARE_ANNUAL_DATA, VERSION, DATFILE=DATFILE, DIR_DATA=DIR_DATA, DIR_PLOTS=DIR_PLOTS, COMPARE_SENSOR=COMPARE_SENSOR, OVERWRITE=OVERWRITE
...
; ****************************************************************************************************
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    CASE VER OF
      ...
      'V2023': BEGIN & DATASETS='OCCCI' & PRODS=['CHLOR_A-CCI','PPD-VGPM2'] & OMAP='NES' & DR = ['1998','2022'] & END      
    ENDCASE
