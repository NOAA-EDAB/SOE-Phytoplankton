...
; ****************************************************************************************************
  ...
  FOR SA=0, N_ELEMENTS(SHPFILES)-1 DO BEGIN ; LOOP THROUGH SUBAREA SHAPE FILES
    ...
    FOR PP=0, N_ELEMENTS(PPRODS)-1 DO BEGIN ; LOOP THROUGH PRODS
      ...
      SOE_PP_REQUIRED_STACKED, VERSTR, DIR_DATA=DIR_OUT, SHAPEFILE=SHPFILE, PRODUCTS=PPRODS[PP],SAVEFILES=SAVEFILES  ; Run the version that reads in the "stacked" files
