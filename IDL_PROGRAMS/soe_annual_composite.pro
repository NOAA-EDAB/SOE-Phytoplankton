; $ID:	SOE_ANNUAL_COMPOSITE.PRO,	2020-12-30-17,	USER-KJWH	$
  PRO SOE_ANNUAL_COMPOSITE, VERSION_STRUCT, DATFILE=DATFILE, DIR_DATA=DIR_DATA, DIR_PLOTS=DIR_PLOTS, OVERWRITE=OVERWRITE, BUFFER=BUFFER
...
;
; REQUIRED INPUTS:
;   VERSION_STRUCT......... The SOE Version
;
; OPTIONAL INPUTS:
...
; ****************************************************************************************************
  ...
  IF NONE(DIR_DATA)  THEN DIR_DATA  = VERSTR.DIRS.DIR_PPREQ_EXTRACTS 
  ...
  AFILES = [GET_FILES(DATASETS,PRODS=PRODS,PERIODS='A',DATERANGE=DR,FILE_TYPE='STATS'),$
            GET_FILES(DATASETS,PRODS=PRODS,PERIODS='A',DATERANGE=DR,FILE_TYPE='ANOMS')]
  TFILES = [GET_FILES(TDATASET,PRODS=[CHLSTR.TEMP_PROD,PPDSTR.TEMP_PROD],PERIODS='A',DATERANGE=TYR,FILE_TYPE='STATS'),$
            GET_FILES(TDATASET,PRODS=[CHLSTR.TEMP_PROD,PPDSTR.TEMP_PROD],PERIODS='A',DATERANGE=TYR,FILE_TYPE='ANOMS')]
