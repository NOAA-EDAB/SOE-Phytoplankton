...
; ===> Manually adjust the SOE program steps as needed
  ...
  IF ~N_ELEMENTS(SEASONAL_COMPS)     THEN SEASONAL_COMPS     = 'Y'
...
; ===> Loop through versions
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(STACKED_TIMESERIES) THEN SOE_STACKED_TIMESERIES_PLOT, VER, BUFFER=0
  ...
  ;      T3 = TEXT(6,  40, 'Northeast Fisheries !CScience Center', FONT_COLOR=CLRS(2), FONT_SIZE=8,/DEVICE)
    ...
    IF KEYWORD_SET(SEASONAL_COMPS) THEN BEGIN
      ...
      FOR R=0, N_ELEMENTS(PRODS)-1 DO BEGIN
        ...
        CASE APROD OF
          'CHLOR_A': BEGIN & OPROD='CHLOR_A_0.1_30' & OALG='CCI' & GALG='GSM' & END
          'PPD':     BEGIN & OPROD='PPD_0.1_10' & OALG='VGPM2' & GALG='VGPM2' & END
        ENDCASE
        
        FF = GET_FILES('OCCCI',PRODS=APROD+'-'+OALG, PERIODS='M3', DATERANGE=['20210101','20210331'])
        FF = [FF,GET_FILES('GLOBCOLOUR',PRODS=APROD+'-'+GALG, PERIODS='M3', DATERANGE=['20210401','20210630'])]
        FF = [FF,GET_FILES('GLOBCOLOUR',PRODS=APROD+'-'+GALG, PERIODS='M3', DATERANGE=['20210701','20210930'])]
        FF = [FF,GET_FILES('GLOBCOLOUR',PRODS=APROD+'-'+GALG, PERIODS='M3', DATERANGE=['20211001','20211231'])]
