...
; ===> Loop through versions
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF VERSTR.INFO.YEAR GE '2023' THEN BEGIN
      ...
      IF KEYWORD_SET(PP_REQ_EXTRACTS)    THEN STOP;SOE_PP_REQUIRED, VER
      IF KEYWORD_SET(PHYSIZE_PLOTS)      THEN STOP;SOE_PHYTOSIZE_PLOT, VER, BUFFER=1
      IF KEYWORD_SET(PHYSIZE_COMPOSITES) THEN STOP;SOE_PHYTOSIZE_COMPOSITES, VER, BUFFER=1
      IF KEYWORD_SET(WEEKLY_PLOTS)       THEN STOP;SOE_WEEKLY_PLOTS, VER, BUFFER=BUFFER
      IF KEYWORD_SET(STACKED_TIMESERIES) THEN STOP;SOE_STACKED_TIMESERIES_PLOT, VER, BUFFER=1
      IF KEYWORD_SET(ANNUAL_COMPOSITES)  THEN STOP;SOE_ANNUAL_COMPOSITE, VER, BUFFER=BUFFER
