...
; ===> Manually adjust the SOE program steps as needed
  ...
  IF ~N_ELEMENTS(PHYSIZE_COMPOSITES) THEN PHYSIZE_COMPOSITES = 'Y'
  ...
  IF ~N_ELEMENTS(ANNUAL_COMPOSITES)  THEN ANNUAL_COMPOSITES  = 'Y'
...
; ===> Loop through versions
 ...
 ;     IF KEYWORD_SET(PHYSIZE_COMPOSITES) THEN STOP ;SOE_PHYTOSIZE_COMPOSITES, VER, BUFFER=1
      ...
      IF KEYWORD_SET(ANNUAL_COMPOSITES)  THEN SOE_ANNUAL_COMPOSITE, VERSTR, BUFFER=BUFFER
