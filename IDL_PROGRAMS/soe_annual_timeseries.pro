...
; ****************************************************************************************************
  ...
  IF ~N_ELEMENTS(PRODS) THEN PRODS = ['CHLOR_A','PPD','PPD_TOTAL','PSC_MICRO','PSC_NANO','PSC_PICO','PSC_FMICRO','PSC_FNANO','PSC_FPICO','SST']
  ...
  IF ~FILE_TEST(DATFILE) THEN GOTO, DONE
  ...
  FOR S=0, N_ELEMENTS(PRODS)-1 DO BEGIN
    ...
    CASE VALIDS('PRODS',APROD) OF
      'SST':       BEGIN & STITLE=UNITS('TEMP')       & SRNG=[0,30]    & ATITLE=UNITS('TEMP',/NO_UNIT)      +' Anomaly '+UNITS('TEMP',/NO_NAME) & PSTATS='AMEAN' & ARNG=[-5,5]  & AMID=0 & ASTATS='AMEAN' & END
      'CHLOR_A':   BEGIN & STITLE=UNITS('CHLOR_A')    & SRNG=[0.5,2.0] & ATITLE=UNITS('CHLOR_A',/NO_UNIT)   +' Ratio Anomaly'                   & PSTATS='MED'   & ARNG=[0.5,1.5] & AMID=1 & ASTATS='AMEAN' & END
      'PPD':       BEGIN & STITLE=UNITS('PPD')        & SRNG=[0.0,1.5] & ATITLE=UNITS('PPD',/NO_UNIT)       +' Ratio Anomaly'                   & PSTATS='MED'   & ARNG=[0.6,1.4] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_MICRO': BEGIN & STITLE=UNITS('PSC_MICRO')  & SRNG=[0.0,10]  & ATITLE=UNITS('PSC_MICRO',/NO_UNIT) +' Ratio Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_NANO':  BEGIN & STITLE=UNITS('PSC_NANO')   & SRNG=[0.0,10]  & ATITLE=UNITS('PSC_NANO',/NO_UNIT)  +' Ratio Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_PICO':  BEGIN & STITLE=UNITS('PSC_PICO')   & SRNG=[0.0,10]  & ATITLE=UNITS('PSC_PICO',/NO_UNIT)  +' Ratio Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_FMICRO':BEGIN & STITLE=UNITS('PSC_FMICRO') & SRNG=[0.0,1.0] & ATITLE=UNITS('PSC_FMICRO',/NO_UNIT)+' Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_FNANO': BEGIN & STITLE=UNITS('PSC_FNANO')  & SRNG=[0.0,1.0] & ATITLE=UNITS('PSC_FNANO',/NO_UNIT) +' Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
      'PSC_FPICO': BEGIN & STITLE=UNITS('PSC_FPICO')  & SRNG=[0.0,1.0] & ATITLE=UNITS('PSC_FPICO',/NO_UNIT) +' Anomaly' & PSTATS='MED'   & ARNG=[0.5,2] & AMID=1 & ASTATS='AMEAN' & END
    ENDCASE
    ...
    FOR T=0, N_ELEMENTS(TYPES)-1 DO BEGIN
      ...
      FOR H=0, N_ELEMENTS(SHAPES)-1 DO BEGIN
        ...
        FOR N=0, N_ELEMENTS(NAMES)-1 DO BEGIN
          ...
          CASE ATYP OF
            'STATS': BEGIN & PDATA=GET_TAG(PSTR,PSTATS) & CDATA=GET_TAG(CSTR,PSTATS) & YRNG=SRNG & YTITLE=STITLE & END
            'ANOMS': BEGIN & PDATA=GET_TAG(ASTR,PSTATS) & CDATA=AMID                 & YRNG=ARNG & YTITLE=ATITLE & END
          ENDCASE
