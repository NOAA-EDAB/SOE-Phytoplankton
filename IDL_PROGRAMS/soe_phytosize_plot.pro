...
; ****************************************************************************************************
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    STRUCT[WHERE(STRUCT.MATH EQ 'STACKED_STATS',/NULL)] = 'STATS'
  ...
  ENDIF
            MST = YSET[WHERE(YSET.PROD EQ 'MICRO_PERCENTAGE' AND YSET.SUBAREA EQ ANAME,/NULL)] & OMST=OSET[WHERE(OSET.PROD EQ 'MICRO_PERCENTAGE' AND OSET.SUBAREA EQ ANAME,/NULL)]
            NST = YSET[WHERE(YSET.PROD EQ 'NANO_PERCENTAGE'  AND YSET.SUBAREA EQ ANAME,/NULL)] & ONST=OSET[WHERE(OSET.PROD EQ 'NANO_PERCENTAGE'  AND OSET.SUBAREA EQ ANAME,/NULL)]
            PST = YSET[WHERE(YSET.PROD EQ 'PICO_PERCENTAGE'  AND YSET.SUBAREA EQ ANAME,/NULL)] & OPST=OSET[WHERE(OSET.PROD EQ 'PICO_PERCENTAGE'  AND OSET.SUBAREA EQ ANAME,/NULL)]
